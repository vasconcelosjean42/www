...
const SellProvider: FC<{ children: ReactNode }> = ({ children }) => {
  const [sells, setSells] = useState<ISell[]>([
    ...
    },
    {
      id: uuidv4(),
      buyerName: "Judson",
      buyerNumber: "12345667",
      sellDate: new Date("2024-03-15T01:00:00"),
      typeOfPayment: "PIX",
      paymentValue: 300,
      totalPrice: 200,
      products: [
    ...
    },
    {
      ...
      buyerName: "Pedro",
      buyerNumber: "12345667",
      sellDate: new Date("2024-03-15T05:00:00"),
      typeOfPayment: "PIX",
      paymentValue: 300,
      totalPrice: 250,
      products: [
    ...
    },
    {
      ...
      buyerName: "Bruno",
      buyerNumber: "12345667",
      sellDate: new Date("2024-03-15T16:00:00"),
      typeOfPayment: "PIX",
      paymentValue: 300,
      totalPrice: 150,
      products: [
    ...
    },
    {
      ...
      buyerName: "Leandra",
      buyerNumber: "12345667",
      sellDate: new Date("2024-03-18T01:00:00"),
      typeOfPayment: "PIX",
      paymentValue: 300,
      totalPrice: 210,
      products: [
    ...
    },
    {
      ...
      buyerName: "Juliana",
      buyerNumber: "12345667",
      sellDate: new Date("2024-04-15T05:00:00"),
      typeOfPayment: "PIX",
      paymentValue: 300,
      totalPrice: 255,
      products: [
    ...
    },
    {
      ...
      buyerName: "Jeffersa",
      buyerNumber: "12345667",
      sellDate: new Date("2024-02-10T16:00:00"),
      typeOfPayment: "PIX",
      paymentValue: 300,
      totalPrice: 152,
      products: [
    ...
    },
    {
      ...
      buyerName: "Samara",
      buyerNumber: "12345667",
      sellDate: new Date("2024-02-01T01:00:00"),
      typeOfPayment: "PIX",
      paymentValue: 300,
      totalPrice: 210,
      products: [
    ...
    },
    {
      ...
      buyerName: "Safira",
      buyerNumber: "12345667",
      sellDate: new Date("2024-02-20T12:00:00"),
      typeOfPayment: "PIX",
      paymentValue: 300,
      totalPrice: 255,
      products: [
    ...
    },
    {
      ...
      buyerName: "Louise",
      buyerNumber: "12345667",
      sellDate: new Date("2024-02-20T16:00:00"),
      typeOfPayment: "PIX",
      paymentValue: 300,
      totalPrice: 152,
      products: [
